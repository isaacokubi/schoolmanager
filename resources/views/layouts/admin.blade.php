...
<aside class="sidebar">
    ...
    <a class="{{ in_array($active,['teachers','subjects'])?'active':'' }}" href="{{ route('admin.operations',['section'=>'teachers']) }}">◆ &nbsp; Teachers & Learning Areas</a>
    <a class="{{ $active==='attendance'?'active':'' }}" href="{{ route('admin.operations',['section'=>'attendance']) }}">✓ &nbsp; Attendance</a>
    <a class="{{ in_array($active,['exams','results'])?'active':'' }}" href="{{ route('admin.operations',['section'=>'exams']) }}">▤ &nbsp; Assessments & Results</a>
