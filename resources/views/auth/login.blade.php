    ...
    <div class="container login-shell">
        ...
        <div class="login-card">
            ...
            <form method="post" action="{{ route('login.submit') }}" class="login-form">
                ...
                <div class="login-field">
                    <div class="field-label-row"><label for="password">Password <span>*</span></label><a href="{{ route('login') }}#password-help" class="password-help">Need help?</a></div>
            ...
            <p class="login-note" id="password-help">If you cannot access your account, contact the school office for assistance.</p>
        </div>
    </div>
</section>
