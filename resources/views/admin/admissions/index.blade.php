...
<div class="admissions-summary" aria-label="Admissions summary">
    <div class="admissions-summary-card">
        <span class="summary-icon blue">◌</span>
        <div><strong>{{ $applications->total() }}</strong><span>Applications shown</span></div>
    </div>
    <div class="admissions-summary-card">
        <span class="summary-icon amber">!</span>
        <div><strong>{{ $status === 'pending' ? $applications->total() : '—' }}</strong><span>Pending review</span></div>
    </div>
    <div class="admissions-summary-card">
        <span class="summary-icon green">✓</span>
        <div><strong>{{ $status === 'approved' ? $applications->total() : '—' }}</strong><span>Approved</span></div>
    </div>
    <div class="admissions-summary-card">
        <span class="summary-icon red">×</span>
        <div><strong>{{ $status === 'rejected' ? $applications->total() : '—' }}</strong><span>Rejected</span></div>
    </div>
</div>
