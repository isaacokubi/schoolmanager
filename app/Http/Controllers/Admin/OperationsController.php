...
class OperationsController extends Controller
{
    ...
    private function prepare($section,array $data,Request $request,$id=null){if($section==='announcements'){$data['published']=$request->boolean('published');$data['published_at']=$data['published']?now():null;}if($section==='results'){$level=app(CbcReportCardService::class)->level($data['marks']===null?null:(float)$data['marks']);if($data['assessment_status']==='missed'){$data['marks']=null;$data['grade']=null;$data['achievement_level']='MISSED';$data['achievement_points']=null;}else{$data['grade']=$level['code'];$data['achievement_level']=$level['code'];$data['achievement_points']=$level['points'];}}return $data;}
}
